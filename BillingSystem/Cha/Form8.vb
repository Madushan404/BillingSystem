...
Public Class Form8
    ...
    Private Sub IconButton6_Click(sender As Object, e As EventArgs) Handles LogOutbtn.Click
        ...
        If MessageBox.Show("Do You want a Log-out", "Log-out", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
    ...
    Private Sub Inventorybtn_Click(sender As Object, e As EventArgs) Handles Inventorybtn.Click
        ActivateButton(sender, RGBColors.color1)
        OpenChildForm(New Invantry_All)
    End Sub
    ...
    Private Sub Usermanegmentbtn_click(sender As Object, e As EventArgs) Handles Usermanegmentbtn.Click
        ActivateButton(sender, RGBColors.color1)
